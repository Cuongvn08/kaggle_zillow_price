...
print('Loading Train ...')
train2016 = pd.read_csv('/data/kaggle/zillow_prize/train_2016_v2.csv', parse_dates=['transactiondate'], low_memory=False)
train2017 = pd.read_csv('/data/kaggle/zillow_prize/train_2017.csv', parse_dates=['transactiondate'], low_memory=False)
...
sample_submission = pd.read_csv('/data/kaggle/zillow_prize/sample_submission.csv', low_memory = False)
